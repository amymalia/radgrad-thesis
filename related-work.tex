...
\caption{STAR Academic Essentials page.}
\end{figure}
...
\caption{STAR Academic Graduation Pathway page.}
\end{figure}
...
\caption{STAR Academic Scholarship Home page.}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{star_scholar3}
\caption{STAR Academic Scholarship Best Fit page.}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{star_scholar4}
\caption{STAR Academic Scholarship Keyword Search page.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{myedu_home}
\caption{MyEdu Home Page.}
\end{figure}
\subsection{MyEdu} 
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{myedu_gpa}
\caption{MyEdu example GPA Calculator.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{myedu_schedplan}
\caption{MyEdu Schedule Planner.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{myedu_profile}
\caption{MyEdu Profile page.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{myedu_jobs}
\caption{MyEdu Job Search page.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{myedu_rateprof1}
\caption{MyEdu Professor Create Recommendations page.}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{myedu_rateprof2}
\caption{MyEdu Professor Create Recommendations second page.}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{myedu_rateprof3}
\caption{MyEdu Professor Recommendations viewing page.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{myedu_class}
\caption{MyEdu example Course page statistics.}
\end{figure}
...
\centering
\includegraphics[width=1.0\textwidth]{myedu_schedplan}
\caption{MyEdu Schedule Planning page.}
\end{figure}
...
\subsection{Social Networks and RadGrad}
